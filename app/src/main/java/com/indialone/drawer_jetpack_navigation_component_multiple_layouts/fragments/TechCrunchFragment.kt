...
import com.indialone.drawer_jetpack_navigation_component_multiple_layouts.databinding.FragmentTechCrunchBinding
...
class TechCrunchFragment : Fragment() {
    ...
    private lateinit var mBinding: FragmentTechCrunchBinding
    ...
    override fun onCreateView(
        ...
        mBinding = FragmentTechCrunchBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsViewModel.getTechCrunchNews().observe(viewLifecycleOwner) { newsEntity ->
            ...
            mBinding.rvNews.adapter = NewsItemAdapter(newsEntity.articles as ArrayList<ArticlesItem>)
        }

        mBinding.swipeToRefresh.setOnRefreshListener {
            newsViewModel.fetchTechCrunchNews()
        }
